...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li class="active"><a href="managementUser.html"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    <li> <a href="managementWorks.html"><i class="icon icon-signal"></i> <span>Charts &amp; graphs</span></a> </li>
    <li> <a href="managementTheme.html"><i class="icon icon-inbox"></i> <span>Widgets</span></a> </li>
    <li><a href="managementApproval.html"><i class="icon icon-th"></i> <span>Tables</span></a></li>
    <li><a href="managementMessages.html"><i class="icon icon-fullscreen"></i> <span>Full width</span></a></li>
