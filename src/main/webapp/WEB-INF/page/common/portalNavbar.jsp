...
<!--必须有,不然会页面错乱  -->
<div id="header">
 <!--  <h1><a href="dashboard_MY2.html">Matrix Admin</a></h1> -->
</div>
<!--close-Header-part--> 

<!--top-Header-menu-->
<!--style="left: 0px;" 的作用是去掉左侧的的导航栏  -->
<div  id="user-nav" class="navbar navbar-inverse">
  ...
  <ul class="nav">
				...
				class="dropdown-toggle"><i class="icon icon-user"></i> <span
					class="text">&nbsp;<b><%=usr.getUsername() %></b>&nbsp;</span><b class="caret"></b></a>
				<ul class="dropdown-menu">
					<li><a href="${basePath}managementProfile.html?id=<%=usr.getId()%>"><i class="icon-user"></i>个人资料</a></li>
					<li class="divider"></li>
					<%
		...
		<li class="dropdown" id="menu-messages"><a href="javascript:void(0);"
			...
			%>		
					<div class="span9"></div>
  		<ul class="nav">
    <li class=""><a title="" href="register.html"><i class="icon icon-share-alt"></i> <span class="text">注册</span></a></li>
    <li class=""><a title="" href="login.html"><i class="icon icon-signin"></i> <span class="text">登录</span></a></li>
      </ul>
    <%
    }
    %>
