									...
									<%-- 		<td style="text-align: center;"><input width="10px"
										...
										<%-- 	<td width="8%">${works.filesize/(1024)}kb</td> --%>
											...
											<td width="15%"><fmt:formatDate
						          	        ...
						          	        <td><button class="approval_setting" class="btn btn-mini"><i class="icon-pencil"></i></button></td>		
										</tr>
									</c:forEach>
									<!-- 
									id 编号
...
<!-- 	<div id="alertModal" class="modal hide">
	...
	<div class="modal-body">
		<div class="widget-content nopadding"
			style="border-bottom: 0px #cdcdcd;">
			<form  class="form-horizontal" action="${basePath}myApproval" 
			name="save_ApprovalSetting" id="myApproval"><%--novalidate="novalidate" --%>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<!-- <textarea rows="4" cols="50" maxlength="50"> -->
							<textarea required rows="10" cols="50"  name="approvalComment"></textarea>
					</div>
				</div>
...
<!-- managementApprovalSetting.jsp -->
	<script src="js/worksApproval/managementMyApprovalTodo.js"></script>
